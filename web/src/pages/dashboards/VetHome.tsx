...
export function VetHome() {
  ...
  const bottomNav: Array<{ to: string; label: string }> = [
    ...
    { to: "/farm/batch-schedule", label: "Igenamiterere" },
  ];
  ...
  return (
    <div className="mx-auto max-w-lg space-y-5">
      ...
      <PageHeader
        ...
        title="Intera ya Vet"
        subtitle="Gukurikirana rounds, ubuzima bw'amatungo n'ibyihutirwa."
        action={
          <Link
          ...
          >
            Igenamiterere rya rounds
          </Link>
        }
      />

      {loading && <SkeletonList rows={2} />}
      {!loading && loadError ? <ErrorState message={loadError} onRetry={() => void load()} /> : null}
